...
def random_brightness(x, brightness_range):
    """Performs a random brightness change for the image.
    # Arguments
        x: Input tensor. Must be 3D.
        brightness_range: Tuple of floats; brightness range (min,max) for the image.
    # Returns
        Brightness changed Numpy image tensor.
    # Raises
        ValueError: if `zoom_range` isn't a tuple.
    """
...
def _array_to_img(x, data_format=None, scale=True):
