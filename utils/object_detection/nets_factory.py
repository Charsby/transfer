...
networks_map = {
                ...
                'dsod':dsod_v1.dsod_net,
                'grp_dsod':dsod_v2.dsod_net,
                }

arg_scopes_map = {
                  'ssd_300_vgg': ssd_vgg_300.ssd_arg_scope,
                  'ssd_512_vgg': ssd_vgg_512.ssd_arg_scope,
                  'dsod':dsod_v1.dsod_net_arg_scope,
                  'grp_dsod':dsod_v2.dsod_net_arg_scope,
                  }

networks_obj = {'ssd_300_vgg': ssd_vgg_300.SSDNet,
                'ssd_512_vgg': ssd_vgg_512.SSDNet,
                'dsod': dsod_v1.DSODNet,
                'grp_dsod': dsod_v2.DSODNet,
